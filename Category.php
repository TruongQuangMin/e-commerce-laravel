...
class Category extends Model
{
    ...
    /**
     * Lấy sản phẩm thuộc về danh mục này.
     */
    public function productsCat()
    {
        return $this->hasMany(Product::class); // Giả sử mỗi Category có nhiều Product
    }

    /**
     * Lấy 4 sản phẩm đầu tiên trong danh mục.
     *
     * @return Collection
     */
    public static function getFirstFourProducts()
    {
